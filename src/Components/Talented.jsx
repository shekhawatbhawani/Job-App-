  ...
  return (
    <div className='flex flex-wrap justify-center px-4 sm:px-8 md:px-16'>
      <aside className='w-full sm:w-5/12 md:w-4/12 p-3'>
        ...
        <h3 className='text-lg font-semibold my-2'>Quick and Easy Way to Advertise</h3>
        ...
        <h3 className='text-lg font-semibold my-2'>Reach out to qualified matches:</h3>
        ...
        <div className='mt-4 flex gap-4'>
            <button className='bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600'>POST A JOB</button>
            <button className='border border-gray-500 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-100'>LEARN MORE</button>
        </div>
      </aside>
      ...
      <aside className='w-full sm:w-5/12 md:w-4/12 p-3 mt-6 sm:mt-0'>
        ...
        <h3 className='text-lg font-semibold my-2'>Get discovered by companies looking to hire remote</h3>
